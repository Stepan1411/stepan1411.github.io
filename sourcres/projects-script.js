...
<li>This will be a highly advanced private server with custom mods, lore, and events. They're calling it a "poor man's MineShield."</li>
            ...
            ru: `<h3>О сервере</h3>
<ul>
<li>Это будет высокотехнологичный частный сервер с собственными модами, лором и событиями. Его называют "MineShield для бедных". Заполнить заявку forms.gle/Pji6RCjPS7VhFAzs7</li>
</ul>`
        },
